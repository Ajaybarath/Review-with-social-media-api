...
# write your code below
    ...
    def publish_photo_msg(self, message, image_url):
        ...
        url = "https://api.pinterest.com/v1/pins/?access_token="+ self.page_access_token


        payload = 'note='+ message +'&image_url='+ image_url +'&board='+ self.board_id
        headers = {
...
# temp1 = Pinterest()
# temp1.publish_photo_msg('test3', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJbCBn4qFq0b3vc--H_N0L28TFW5Mvp4ARvS6OfyMTmZUw_lJZ&s&board=634655841177853448')
